...
export function initDb() {
  ...
  const defaults = {
    ...
    dry_run_buy_sol: '0.1',
    dry_run_slippage_percent: '2',
    default_tp_percent: '75',
    default_sl_percent: '-35',
    default_trailing_enabled: 'true',
    default_trailing_percent: '10',
  ...
  stratInsert.run('sniper', 'Sniper', 1, JSON.stringify({
    ...
    momentum_timeout_ms: 8000,
    use_dynamic_sl: true,
    atr_sl_multiplier: 2.5,
    atr_sl_floor_percent: -50,
    atr_sl_ceiling_percent: -8,
  }), ts);
